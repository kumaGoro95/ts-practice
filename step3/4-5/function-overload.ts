...
function transform(item?: Brooch | Compact): void {
    ...
    } else if (item instanceof CosmicCompact) { console.log('Moon cosmic power💖, make up!!!');
    } else if (item instanceof CrisisCompact) { console.log('Moon crisis🏆, make up!');
    } else if (item === undefined) { console.log('Moon prisim power🌙, make up!');
    } else {
